...
% \begin{gather*}
%     \left| W_{\text{з}}(j\omega) \right| = \frac{
%         \left| W_{O_2} (j \omega) W_p (j \omega) \right|
%     }{
%         \left| 1 + W_{O_2} (j \omega) W_p (j \omega) \right|
%     } = 
%     \frac{
%         \left|\frac{k e^{-\tau j \omega}}{(T_1 j \omega + 1)(T_2 j \omega + 1)} \cdot  K_p \cdot \frac{T_1 j \omega + 1}{T_1 j \omega} \right|
%     }{
%         \left|1 + \frac{k e^{-\tau j \omega}}{(T_1 j \omega + 1)(T_2 j \omega + 1)} \cdot  K_p \cdot \frac{T_1 j \omega + 1}{T_1 j \omega} \right|
%     } =
% \end{gather*}
